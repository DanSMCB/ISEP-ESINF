...
class PlatformTest {
    ...
    @Test
    public void country_listTest() throws Exception {
        List<String> l = Files.lines(Paths.get("FAOSTAT_data_en_9-7-2022_SMALL.csv")).collect(Collectors.toList());
        instance.getCountry(l);

        assertEquals("Portugal", instance.country_list("Apples", 1000).get(0).getAreaCountry());
        assertEquals("Spain", instance.country_list("Apples", 1000).get(1).getAreaCountry());    
    }
